...
@endif --}}
    ...
    <form method="POST" action="{{ route('comics.update', ['comic' => $comic->id]) }}">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" id="description" rows="3" name="description">{{ old('description', $comic->description) }}
                {{-- <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="date" id="start" name="sale_date" value="{{ old('sale_date', $comic->sale_date) }}" min="2023-01-01" max="2025-12-31">
            <div class="invalid-feedback">
